            ...
            {navigationItems.map((item) => (
              item.href ? (
                <Link 
                  key={item.name}
                  to={item.href} 
                  className="block py-2 px-4 text-gray-600 hover:bg-blue-50 hover:text-blue-600 rounded transition-colors duration-300"
                ...
                <button 
                  key={item.name}
                  onClick={item.action} 
                  className="block w-full text-left py-2 px-4 text-gray-600 hover:bg-blue-50 hover:text-blue-600 rounded transition-colors duration-300"
                >
                  {item.name}
                </button>
              )
