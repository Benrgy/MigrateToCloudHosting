  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:image" content={`${window.location.origin}/calculator-preview.jpg`} />
        <meta property="og:site_name" content="Website Performance Calculator" />
        ...
        <meta name="twitter:image" content={`${window.location.origin}/calculator-preview.jpg`} />
      </Helmet>
      {children}
    </>
  );
